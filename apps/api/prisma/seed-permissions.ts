...
export const SEED_PERMISSIONS: SeedPermission[] = [
  ...
  {
    slug: 'principal-mobile:access',
    resource: 'principal-mobile',
    action: 'access',
    description:
  ...
  },
  {
    ...
    resource: 'website',
    action: 'read',
    description: 'View website CMS content and revisions',
  },
  {
    slug: 'website:edit',
    resource: 'website',
    action: 'edit',
    description: 'Manage website settings, pages, media, and redirects',
  },
  {
    slug: 'website:publish',
    resource: 'website',
    action: 'publish',
    description: 'Publish and unpublish website content',
  },
  {
    slug: 'website:media',
    resource: 'website',
    action: 'media',
    description: 'Upload and manage website media assets',
  },
  {
    slug: 'website:manage',
    resource: 'website',
    action: 'manage',
    description: 'Legacy full website CMS management alias',
  },
  {
    slug: 'website:news:read',
    resource: 'website',
    action: 'news:read',
    description: 'View website news entries',
  },
  {
    slug: 'website:news:edit',
    resource: 'website',
    action: 'news:edit',
    description: 'Create and edit website news',
  },
  {
    slug: 'website:notices:read',
    resource: 'website',
    action: 'notices:read',
    description: 'View website notice board',
  },
  {
    slug: 'website:notices:edit',
    resource: 'website',
    action: 'notices:edit',
  ...
  },
  {
    ...
    description: 'Edit website department profiles',
  },
  {
    slug: 'website:seo',
    resource: 'website',
    action: 'seo',
    description: 'Manage website SEO settings',
  },
  {
    slug: 'website:review',
    resource: 'website',
    action: 'review',
    description: 'Review website content before publish',
  },
];
