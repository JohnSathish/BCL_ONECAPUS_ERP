...
const DEFAULT_LAYOUT: ThemeLayoutOptions = {
  glassEnabled: true,
...
export const THEME_PRESETS: Record<string, ThemePreset> = {
  ...
  'midnight-executive': {
    ...
    category: 'Dark',
    purpose:
      'Premium dark enterprise control center for analytics and AI modules',
  ...
  'slate-pro-enterprise': {
    ...
    category: 'Corporate',
    purpose:
      'Serious operations theme for tables, audit logs, attendance, payroll, and finance',
  ...
  'neo-glass-enterprise': {
    ...
    category: 'Futuristic',
    purpose:
      'Futuristic campus OS theme for demos, AI dashboards, and premium branding',
