...
export const SCHOOL_IAM_MODULES: IamModuleDef[] = [
  ...
  },
  {
    ...
    label: 'Attendance',
    actions: [
      { action: 'view', slug: 'attendance.view', label: 'View attendance' },
      { action: 'create', slug: 'attendance.create', label: 'Mark attendance' },
      { action: 'edit', slug: 'attendance.update', label: 'Edit attendance' },
      {
        action: 'create',
        slug: 'attendance.submit',
        label: 'Submit attendance',
      },
      {
        action: 'create',
        slug: 'attendance.correction.request',
      ...
      { action: 'manage', slug: 'attendance.lock', label: 'Unlock attendance' },
      {
        action: 'manage',
