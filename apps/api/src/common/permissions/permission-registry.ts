...
export const PLATFORM_PORTAL_PERMISSIONS = [
  ...MODULE_PERMISSIONS.platform,
] as const;
...
export const ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  {
    prefix: '/platform/licenses',
    permissions: [...MODULE_PERMISSIONS.platform],
  },
  {
    prefix: '/platform/license-keys',
    permissions: [...MODULE_PERMISSIONS.platform],
  },
  ...
  {
    prefix: '/admin/id-cards',
    permissions: [...MODULE_PERMISSIONS.students, 'staff:read'],
  },
  {
  ...
  {
    prefix: '/admin/academics/timetable',
    permissions: [...MODULE_PERMISSIONS.timetable],
  },
  {
  ...
  {
    prefix: '/admin/academics/question-bank',
    permissions: [...MODULE_PERMISSIONS.questionBank],
  },
  {
    prefix: '/admin/academics/syllabus-repository',
    permissions: [
      ...MODULE_PERMISSIONS.syllabusRepository,
...
export const WORKSPACE_TEMPLATES: WorkspaceTemplate[] = [
  ...
  },
  {
    slug: 'hr-manager',
    name: 'HR Manager',
    description: 'Payroll processing, structures, assignments, loans',
    permissions: [
      'payroll:read',
      'payroll:manage',
      'payroll:process',
...
export const DASHBOARD_WIDGET_PERMISSIONS: Record<string, string[]> = {
  ...
  'pending-approvals': [
    ...MODULE_PERMISSIONS.administration,
    ...MODULE_PERMISSIONS.certificates,
  ],
...
export function canAccessPlatformPortal(
  ...
  return hasAnyListedPermission(permissions, roles, [
...
export function resolveDefaultAdminHome(
  permissions: string[],
  roles: string[],
): string {
  ...
  for (const mod of ERP_MODULES) {
    ...
    const matchCount = mod.permissions.filter((p) =>
      permissions.includes(p),
    ).length;
    if (matchCount > 0)
      moduleHomes.push({ count: matchCount, home: mod.defaultHome });
  }
...
export function getAccessibleModules(
  ...
  return ERP_MODULES.filter((m) =>
    hasAnyListedPermission(permissions, roles, [...m.permissions]),
  );
}
