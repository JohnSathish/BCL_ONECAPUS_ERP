...
const MORNING_POOLS = [
  { name: 'Morning Shift Sem 2 MDC', codes: MORNING_SEM2_MDC_CODES },
  { name: 'Morning Shift Sem 2 AEC', codes: MORNING_SEM2_AEC_CODES },
  { name: 'Morning Shift Sem 2 SEC', codes: MORNING_SEM2_SEC_CODES },
  { name: 'Morning Shift Sem 2 VAC', codes: MORNING_SEM2_VAC_CODES },
] as const;
