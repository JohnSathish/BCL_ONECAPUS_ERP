...
import { PHYSICS_NEHU_PAPERS } from '../src/modules/academic-engine/domain/physics-fyugp-nehu';
...
async function main() {
  ...
  for (const paper of PHYSICS_NEHU_PAPERS) {
  ...
  for (const legacy of ['PHY-302 B', 'PHY-302B', 'PHY-304']) {
