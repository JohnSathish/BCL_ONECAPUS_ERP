...
const DAY_POOLS = [
  { name: 'Day Shift Sem 1 MDC', codes: DAY_SEM1_MDC_CODES },
  { name: 'Day Shift Sem 1 AEC', codes: DAY_SEM1_AEC_CODES },
  { name: 'Day Shift Sem 1 SEC', codes: DAY_SEM1_SEC_CODES },
  { name: 'Day Shift Sem 1 VAC', codes: DAY_SEM1_VAC_CODES },
] as const;
