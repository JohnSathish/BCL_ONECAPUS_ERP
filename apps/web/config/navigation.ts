    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          {
            label: 'My Metrics',
            href: '/admin/naac/my-metrics',
            permissions: ['naac-iqac:read', 'naac-iqac:collect', 'naac-iqac:manage'],
          },
          {
          ...
          {
            label: 'Calendar',
            href: '/admin/naac/calendar',
            permissions: ['naac-iqac:read', 'naac-iqac:manage'],
          },
          { label: 'AQAR', href: '/admin/naac/aqar', permissions: ['naac-iqac:manage'] },
          {
            label: 'SSR / Reports',
            href: '/admin/naac/reports',
            permissions: ['naac-iqac:reports'],
          },
          ...
          { label: 'DVV Compliance', href: '/admin/naac/dvv', permissions: ['naac-iqac:reports'] },
