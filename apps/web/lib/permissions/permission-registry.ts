...
export const MODULE_PERMISSIONS = {
  ...
  parentPortal: ['parent-portal:read', 'parent-portal:manage', 'parent:portal:self'],
...
export const ERP_MODULES: ErpModule[] = [
  ...
  {
    id: 'syllabusRepository',
    label: 'Syllabus Repository',
    permissions: MODULE_PERMISSIONS.syllabusRepository,
    defaultHome: '/admin/academics/syllabus-repository',
  },
  {
    id: 'shortTermCourses',
    label: 'Short-Term Courses',
    permissions: MODULE_PERMISSIONS.shortTermCourses,
    defaultHome: '/admin/academics/short-term-courses',
  },
  {
    id: 'departmentActivities',
...
export const ROUTE_PERMISSION_RULES: RoutePermissionRule[] = [
  ...
  {
    prefix: '/admin/administration/official-documents',
    permissions: [
      'official-documents:read',
      'official-documents:manage',
      'official-documents:approve',
  ...
  },
  {
    ...
    permissions: [...MODULE_PERMISSIONS.administration, ...MODULE_PERMISSIONS.officialDocuments],
  },
  ...
  { prefix: '/admin/helpdesk', permissions: [...MODULE_PERMISSIONS.helpdesk] },
  { prefix: '/admin/parent-portal', permissions: [...MODULE_PERMISSIONS.parentPortal] },
  { prefix: '/admin/visitor-management', permissions: [...MODULE_PERMISSIONS.visitorManagement] },
  { prefix: '/admin/placement', permissions: [...MODULE_PERMISSIONS.placement] },
  { prefix: '/admin/internship', permissions: [...MODULE_PERMISSIONS.internship] },
  { prefix: '/admin/alumni', permissions: [...MODULE_PERMISSIONS.alumni] },
  { prefix: '/admin/journals', permissions: [...MODULE_PERMISSIONS.journals] },
  { prefix: '/admin/website', permissions: [...MODULE_PERMISSIONS.website] },
  { prefix: '/admin/hostel', permissions: [...MODULE_PERMISSIONS.hostel] },
  { prefix: '/admin/research', permissions: [...MODULE_PERMISSIONS.research] },
  { prefix: '/admin/workflow', permissions: [...MODULE_PERMISSIONS.workflow] },
  { prefix: '/admin/integrations', permissions: [...MODULE_PERMISSIONS.integrations] },
  ...
  { prefix: '/admin/school-admissions', permissions: [...MODULE_PERMISSIONS.admissions] },
  {
  ...
  {
    prefix: '/admin/academics/syllabus-repository',
    permissions: [...MODULE_PERMISSIONS.syllabusRepository],
  },
  {
    prefix: '/admin/academics/short-term-courses',
    permissions: [...MODULE_PERMISSIONS.shortTermCourses],
  },
  {
  ...
  { prefix: '/admin/examination-fees', permissions: [...MODULE_PERMISSIONS.examinations] },
