...
export function themeTokensToCssVars(
  ...
  const vars: Record<string, string> = {
    ...
    '--border-color': mixHex(tokens.border, tokens.primary, 0.14),
    '--border-color-hover': mixHex(tokens.border, tokens.primary, 0.32),
    '--border-color-focus': tokens.primary,
    '--border-subtle': mixHex(tokens.surface, tokens.border, 0.48),
    '--border-strong': mixHex(tokens.border, tokens.primary, 0.24),
    '--control-background': tokens.surface,
