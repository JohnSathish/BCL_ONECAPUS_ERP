    ...
    items: [
      {
        ...
        status: 'active',
        children: [
          live('reports-hub', 'All reports', '/admin/school-sis/reports'),
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        ...
        status: 'active',
        children: [
          live('fee-settings', 'Fee settings', '/admin/school-sis/fees/settings'),
          live('report-design-settings', 'Reports & documents', '/admin/school-sis/reports/design'),
        ],
      },
      {
