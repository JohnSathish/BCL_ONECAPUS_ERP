    ...
    <>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent className="max-w-xl overflow-hidden p-0">
          <DialogTitle className="sr-only">Campus search and OneCampus AI Assistant</DialogTitle>
          <Command
              ...
              <Command.Input
                ...
                placeholder={
                  isStaffPortal
                    ...
                    : 'OneCampus AI Assistant — ask, search students, fees, reports…'
                }
            ...
            <Command.List className="max-h-80 overflow-y-auto p-2">
              <Command.Empty className="py-6 text-center text-sm text-muted-foreground">
                {isStaffPortal
                  ...
                  : 'No matches — press Enter to ask OneCampus AI Assistant.'}
              </Command.Empty>

              {!isStaffPortal && showAskAiItem ? (
                <Command.Group heading="OneCampus AI Assistant" className="px-2 py-2">
                  <Command.Item
                    value={`ask-ai ${search}`}
