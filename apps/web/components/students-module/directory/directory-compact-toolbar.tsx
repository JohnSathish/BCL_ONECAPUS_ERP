...
import { ChevronDown, Download, ImagePlus, Import, Plus, Settings2 } from 'lucide-react';
...
export function DirectoryCompactToolbar({
  ...
  return (
    <div className="sticky top-0 z-20 space-y-1.5">
      <div className="glass-card rounded-xl border border-border/50 px-2.5 py-2">
            ...
            <DropdownMenuContent align="start" className="w-52">
              {canManage ? (
                <>
                  ...
                  {canManagePhotos ? (
                    <DropdownMenuItem asChild>
                      <Link href={photoUploadHref}>Bulk Photo Upload</Link>
                    </DropdownMenuItem>
                  ) : null}
                  <DropdownMenuItem asChild>
                    <Link href={subjectsHref}>Assign Subjects</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem asChild>
                    <Link href={promoteHref}>Promote</Link>
                  </DropdownMenuItem>
                  <DropdownMenuItem disabled>Generate Login</DropdownMenuItem>
                  <DropdownMenuItem disabled>Send SMS</DropdownMenuItem>
                  <DropdownMenuItem disabled>Assign RFID</DropdownMenuItem>
                  <DropdownMenuItem disabled>Move Section</DropdownMenuItem>
                </>
              ) : null}
              {canExport ? (
                <>
