...
import { validateNehuRollNumber } from '@/components/students-module/add-student/constants/nehu-fields';
...
export const basicStepSchema = z.object({
  ...
  enrollmentNumber: z
    .string()
    .trim()
    .min(2, 'NEHU Registration Number is required.')
  ...
  mobileNumber: z
    ...
    .optional()
    .refine(
      (v) => !v || mobileRegex.test(v.replace(/\s/g, '')),
