        ...
        {selectedItems.length > 0 ? (
          <PaymentCartBar
            ...
            onlineDisabledMessage={
              account?.studentPortal?.onlineEnabled === false
                ? 'Online payment is not available for this institution.'
                : 'Mobile Razorpay payment is turned off. Pay via the college web portal or accounts office.'
            }
            paying={paying}
...
function PaymentCartBar({
  ...
  return (
    <View style={styles.cartBar}>
      ...
      {!onlineEnabled ? <Text style={styles.hintWarn}>{onlineDisabledMessage}</Text> : null}
    </View>
  );
}
