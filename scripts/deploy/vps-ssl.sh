...
EXTRA_DOMAINS="${SSL_EXTRA_DOMAINS:-admissions.donboscocollege.ac.in,library.donboscocollege.ac.in,career.donboscocollege.ac.in,pay.donboscocollege.ac.in,alumni.donboscocollege.ac.in,transient.donboscocollege.ac.in,source.donboscocollege.ac.in}"
...
http {
  server {
    listen 80;
    server_name erp.donboscocollege.ac.in admissions.donboscocollege.ac.in library.donboscocollege.ac.in career.donboscocollege.ac.in pay.donboscocollege.ac.in alumni.donboscocollege.ac.in transient.donboscocollege.ac.in source.donboscocollege.ac.in;
